...
public interface TestConstants {
    ...
    String FIXER_API_URL_BASE_TARGET_AND_TIMESTAMP = "http://api.fixer.io/2017-01-10?base=USD&symbols=CAD,EUR,GBP";
    ...
    String FIXER_API_URL_EXCEPTION_TIMESTAMP = "http://api.fixer.io/1900-01-01?base=USD";
